...
export const DEMO_SHOPS = [
  ...
  { slug: 'GNSHKLKI', shop_name: 'New Ganesh Traders', owner_name: 'V. Ganesan', category: 'Retail', address: 'Chinnasalem Road, Kallakurichi', latitude: 11.76, longitude: 78.972, is_open: true, acceptance_sla_minutes: 5, pickup_hold_minutes: 90, prep_time_minutes: 10, auto_confirm: false, price_display_mode: 'exact', price_mode: 'exact' },
