...
export const DEMO_SHOPS = [
  { slug: 'MRGNKLKI', shop_name: 'Sri Murugan Stores', owner_name: 'R. Murugan', category: 'Grocery', address: 'Gandhi Road, Kallakurichi', latitude: 11.7415, longitude: 78.9603, is_open: true, acceptance_sla_minutes: 5, pickup_hold_minutes: 90, prep_time_minutes: 10, auto_confirm: false, price_display_mode: 'exact', price_mode: 'exact' },
  { slug: 'AMMAKLKI', shop_name: 'Amma Super Mart', owner_name: 'S. Selvi', category: 'Supermarket', address: 'Salem Main Road, Kallakurichi', latitude: 11.7365, longitude: 78.955, is_open: true, acceptance_sla_minutes: 5, pickup_hold_minutes: 90, prep_time_minutes: 10, auto_confirm: true, price_display_mode: 'range', price_mode: 'range' },
  { slug: 'LXMIKLKI', shop_name: 'Lakshmi Provisions', owner_name: 'K. Lakshmi', category: 'Grocery', address: 'Bus Stand Road, Kallakurichi', latitude: 11.748, longitude: 78.967, is_open: false, acceptance_sla_minutes: 5, pickup_hold_minutes: 90, prep_time_minutes: 10, auto_confirm: false, price_display_mode: 'hidden', price_mode: 'hidden' },
  { slug: 'GNSHKLKI', shop_name: 'New Ganesh Traders', owner_name: 'V. Ganesan', category: 'Wholesale', address: 'Chinnasalem Road, Kallakurichi', latitude: 11.76, longitude: 78.972, is_open: true, acceptance_sla_minutes: 5, pickup_hold_minutes: 90, prep_time_minutes: 10, auto_confirm: false, price_display_mode: 'exact', price_mode: 'exact' },
  { slug: 'BRTIKLKI', shop_name: 'Bharathi Mini Mart', owner_name: 'M. Bharathi', category: 'Supermarket', address: 'Ulundurpet Road, Kallakurichi', latitude: 11.715, longitude: 78.94, is_open: true, acceptance_sla_minutes: 5, pickup_hold_minutes: 90, prep_time_minutes: 10, auto_confirm: false, price_display_mode: 'range', price_mode: 'range' },
  { slug: 'KOVLKLKI', shop_name: 'Kovil Kadai', owner_name: 'P. Anand', category: 'Grocery', address: 'Melmalayanur Road', latitude: 11.81, longitude: 79.01, is_open: true, acceptance_sla_minutes: 5, pickup_hold_minutes: 90, prep_time_minutes: 10, auto_confirm: false, price_display_mode: 'hidden', price_mode: 'hidden' },
  { slug: 'SRVNKLKI', shop_name: 'Saravana Bakery', owner_name: 'B. Saravanan', category: 'Bakery', address: 'Trichy Road, Kallakurichi', latitude: 11.739, longitude: 78.964, is_open: true, acceptance_sla_minutes: 5, pickup_hold_minutes: 90, prep_time_minutes: 15, auto_confirm: false, price_display_mode: 'exact', price_mode: 'exact' },
  { slug: 'ANNMKLKI', shop_name: 'Annam Tea Stall', owner_name: 'D. Kumar', category: 'Tea Shop', address: 'Railway Feeder Road, Kallakurichi', latitude: 11.744, longitude: 78.958, is_open: true, acceptance_sla_minutes: 5, pickup_hold_minutes: 90, prep_time_minutes: 5, auto_confirm: true, price_display_mode: 'exact', price_mode: 'exact' },
];
