...
export default function App() {
  ...
  return (
    <>
      ...
      {DEMO && (
        <div className="pointer-events-none fixed inset-x-0 bottom-[calc(3.75rem+env(safe-area-inset-bottom))] z-50 flex justify-center px-4 print:hidden">
          <span className="rounded-full bg-ink/85 px-3 py-1 text-[11px] font-semibold text-cream shadow-pop backdrop-blur-sm">
            DEMO · phone: any 10 digits · code 123456
          </span>
        </div>
      )}
    </>
