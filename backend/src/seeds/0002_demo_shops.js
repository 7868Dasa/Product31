...
const SHOPS = [
  { slug: 'MRGNKLKI', shop_name: 'Sri Murugan Stores', owner_name: 'R. Murugan', category: 'Groceries', address: 'Gandhi Road, Kallakurichi', latitude: 11.7415, longitude: 78.9603, is_open: true, price_display_mode: 'exact' },
  ...
  { slug: 'LXMIKLKI', shop_name: 'Lakshmi Provisions', owner_name: 'K. Lakshmi', category: 'Provision Store', address: 'Bus Stand Road, Kallakurichi', latitude: 11.748, longitude: 78.967, is_open: false, price_display_mode: 'hidden' },
  ...
  { slug: 'BRTIKLKI', shop_name: 'Bharathi Mini Mart', owner_name: 'M. Bharathi', category: 'Mini Mart', address: 'Ulundurpet Road, Kallakurichi', latitude: 11.715, longitude: 78.94, is_open: true, price_display_mode: 'range' },
  { slug: 'KOVLKLKI', shop_name: 'Kovil Kadai', owner_name: 'P. Anand', category: 'Kirana', address: 'Melmalayanur Road', latitude: 11.81, longitude: 79.01, is_open: true, price_display_mode: 'hidden' },
];
